    ...
    <div className="flex justify-center mb-16 mt-12 relative">
      ...
      <div className="bg-white/[0.03] p-2.5 rounded-[3rem] flex gap-3 backdrop-blur-2xl border border-white/5 shadow-[0_20px_50px_rgba(0,0,0,0.3)] relative z-10">
        <button 
          ...
          className={`group flex items-center gap-4 px-12 py-5 rounded-[2.5rem] font-black text-[11px] uppercase tracking-[0.3em] transition-all duration-700 relative overflow-hidden ${activeTab === 'expenses' ? 'bg-indigo-600 text-white shadow-[0_10px_30px_rgba(79,70,229,0.4)] scale-[1.05]' : 'text-slate-500 hover:text-slate-300 hover:bg-white/5'}`}
        >
        ...
        <button 
          ...
          className={`group flex items-center gap-4 px-12 py-5 rounded-[2.5rem] font-black text-[11px] uppercase tracking-[0.3em] transition-all duration-700 relative overflow-hidden ${activeTab === 'incomes' ? 'bg-emerald-600 text-white shadow-[0_10px_30px_rgba(16,185,129,0.4)] scale-[1.05]' : 'text-slate-500 hover:text-slate-300 hover:bg-white/5'}`}
        >
