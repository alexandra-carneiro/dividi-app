      ...
      <div className="w-full max-w-[440px] z-10">
        ...
        <div className="bg-[#111114]/90 backdrop-blur-2xl border border-white/5 p-8 rounded-[2.5rem] shadow-3xl transition-all duration-500 ring-1 ring-white/5">
          ...
          <form className="space-y-6">
            ...
            {/* Modal de Termos e Condições - Versão Clean & Premium */}
            {showTerms && (
              <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/95 backdrop-blur-md animate-in fade-in duration-300">
                <div className="bg-[#0d0d10] border border-white/10 w-full max-w-xl rounded-[2rem] shadow-2xl flex flex-col max-h-[80vh] overflow-hidden ring-1 ring-white/10">
                  
                  {/* Header Fixo e Sólido */}
                  <div className="flex justify-between items-center px-8 py-6 border-b border-white/5 bg-[#111114]">
                    <div className="flex items-center gap-3">
                      <ShieldCheck size={20} className="text-indigo-500" />
                      <h3 className="text-sm font-black text-white uppercase tracking-[0.2em]">Diretrizes de Segurança</h3>
                    </div>
                    <button 
                  ...
                  {/* Área de Texto com Scroll Limpo */}
                  ...
                  {/* Footer com Botão Sólido */}
                  <div className="p-8 border-t border-white/5 bg-[#111114]">
                    <button 
                      type="button"
                      onClick={() => setShowTerms(false)}
                      className="w-full py-4 bg-indigo-600 hover:bg-indigo-500 text-white font-black rounded-xl transition-all shadow-xl shadow-indigo-600/20 tracking-widest uppercase text-xs active:scale-[0.98]"
                    >
