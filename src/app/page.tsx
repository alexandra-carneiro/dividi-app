'use client'
import { ArrowRight, CheckCircle2, ShieldCheck, Sparkles, TrendingUp, Users, Zap, LayoutGrid, Receipt, Calendar, Download, MousePointer2 } from 'lucide-react'
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-50 font-sans selection:bg-indigo-500/30 overflow-x-hidden">
      ...
      {/* Navigation */}
      <nav className="relative z-[100] max-w-7xl mx-auto px-6 py-8 flex justify-between items-center backdrop-blur-sm">
        <Logo onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} />
        <div className="flex items-center gap-8">
          <Link href="/login" className="text-sm font-black text-slate-300 hover:text-white transition-colors uppercase tracking-widest hidden md:block">
            Entrar
          </Link>
      ...
      <main className="relative z-10">
        ...
        <section className="max-w-7xl mx-auto px-6 pt-16 pb-32 grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-12 animate-in fade-in slide-in-from-left-8 duration-1000">
            ...
            <div className="flex flex-col sm:flex-row gap-6 pt-4">
              ...
              <div className="flex items-center gap-4 px-2 text-slate-300 font-bold text-xs uppercase tracking-widest">
            ...
            <div className="flex items-center gap-6 pt-4">
              <div className="flex -space-x-3">
                {[1,2,3,4].map(i => (
                  <div key={i} className="w-12 h-12 rounded-full border-2 border-slate-900 bg-slate-800 flex items-center justify-center overflow-hidden relative shadow-lg">
                    <Image 
              ...
              <div className="space-y-1">
                <p className="text-xs font-black text-white uppercase tracking-widest">+1.200 Residências</p>
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Gerindo finanças com transparência</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative animate-in fade-in slide-in-from-right-8 duration-1000">
            ...
            <div className="relative glass-card rounded-[3rem] p-3 overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] aspect-[1.4/1]">
              ...
              <Image 
                src="/dividi_dashboard_mockup_elite_1778427297273.png" 
        ...
        <section className="bg-slate-900/30 border-y border-white/5 py-32 relative">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-24 space-y-4">
              ...
              <p className="text-4xl md:text-5xl font-black text-white tracking-tighter uppercase italic leading-tight">Engenharia para o seu Lar</p>
            </div>
        ...
        <section className="max-w-4xl mx-auto px-6 pb-40 text-center space-y-16 relative">
           ...
           <div className="space-y-6 relative">
             ...
             <p className="text-xl text-slate-300 font-medium max-w-xl mx-auto leading-relaxed">
           ...
           <div className="flex flex-col sm:flex-row gap-6 justify-center items-center relative">
              ...
              <div className="flex flex-col items-start gap-1">
                ...
                <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Grátis para sempre na versão base</span>
              </div>
           </div>
        </section>
      </main>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <div className="flex gap-10">
              <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">AVANTE DIGITAL PROUDLY BUILT</span>
            </div>
          </div>
        </div>
      </footer>
